...
VALOIS_PART2 = [
    ...
    [22, "Карл V Мудрый,", "(1364-1380)", None, None, "Карл VI Безумный; Людовик (герцог Орлеанский)", None, 2, 10],
    ...
    [28, "Людовик,", "герцог Орлеанский", None, None, "герцоги Орлеанские", None, 3, 30],
...
LUXEMBOURG = [
    ...
    [13, "Альбрехт V Габсбург,", "герцог Австрийский, король Венгрии, Германии и Чехии (1438-1439)", None, None, "Ладислав (Ласло) Постум", "Елизавета", 6, None],
